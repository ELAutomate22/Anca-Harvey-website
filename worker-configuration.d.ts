/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9b7ab45581df1e3a0472c415342ae4c8)
...
interface __BaseEnv_Env {
	...
	ALLOWED_ORIGIN: "https://replace-with-your-private-domain.example" | "http://localhost:5173";
}
declare namespace Cloudflare {
	interface ProductionEnv {
		...
		ASSETS: Fetcher;
		APP_ENV: "production";
		ALLOWED_ORIGIN: "https://replace-with-your-private-domain.example";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "ALLOWED_ORIGIN">> {}
}
